...
# Run the image in QEMU explicitly in headless mode to prevent CI hanging
qemu-system-i386 -cdrom myos.iso -vga std -serial file:out -device isa-debug-exit -display none -no-reboot
